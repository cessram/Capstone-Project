...
Setup:
  ...
  streamlit run psia_dashboard_v11.py
"""
...
with tab5:
    ...
    with ca_r2b:
        ...
        st.plotly_chart(fig_ca4, use_container_width=True)
    ...
    with ca_r3a:
        ...
        st.plotly_chart(fig_ca5, use_container_width=True)
    ...
    with ca_r3b:
        ...
        st.plotly_chart(fig_ca6, use_container_width=True)
